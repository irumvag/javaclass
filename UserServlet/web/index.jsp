            ...
            <div class="d-flex justify-content-center align-items-center py-2">
                <div class="m-auto d-flex flex-column align-items-middle p-4 bg-white shadow rounded">
                    <form action="" method="post" class="mt-5">
                        ...
                        <p class="text-center mt-3">No Account <a href="#" style="text-decoration: none;color: greenyellow">Sign up</a>,    By clicking login, you accept user terms and policies.</p>
                    </form>
                </div>
            </div>
        </div>
