...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="col-md-6 text-end">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="<c:url value='/restaurants'>
                        ...
                        <div class="col" data-aos="fade-up" data-aos-delay="${loop.index * 100}">
                            <div class="card restaurant-card h-100 shadow">
                                <img src="${restaurant.logoUrl != null ? restaurant.logoUrl : 'img/default-restaurant.jpg'}" 
                                     class="card-img-top restaurant-logo" alt="${restaurant.name} logo" loading="lazy">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <a href="${pageContext.request.contextPath}/login" class="btn btn-outline-warning" 
                                                   aria-label="Login to follow ${restaurant.name}">
                                    ...
                                    <p class="mt-2 mb-0">
                                        ...
                                        ${restaurant.contactNumber != null ? restaurant.contactNumber : 'N/A'}
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Back to Top -->
        <button id="backToTop" class="btn btn-warning position-fixed bottom-0 end-0 m-3" style="display: none;" 
