                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-cols-1 row-cols-md-3 g-4 mb-4">
                                    <c:forEach items="${availablePackages}" var="mealPackage" varStatus="loop">
                                        <div class="col" data-aos="fade-up" data-aos-delay="${loop.index * 100}">
                                            <div class="card h-100">
                                                <img src="img/meal-package.jpg" class="card-img-top" alt="${mealPackage.packageName}" style="height: 150px; object-fit: cover;" loading="lazy">
                                                <div class="card-body">
                                            ...
                                            <div class="card h-100">
                                                <div class="card-body">
                                                    ...
                                                    <c:if test="${not empty purchase.redemptionCode}">
                                                        ...
                                                        <div id="qrcode-${purchase.purchaseId}" class="mb-3"></div>
            ...
            button.addEventListener('click', function () {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        this.setAttribute('aria-label', `${isFollowed ? 'Follow' : 'Unfollow'} ${restaurantName}`);
                        if (isFollowed) {
