...
import com.mycompany.duneix.web.models.home.PurchasedPackage;
import com.mycompany.duneix.web.models.home.Restaurant;
import com.mycompany.duneix.web.models.home.RoleRequest;
...
public class UserDashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            String purchaseSql = "SELECT ump.purchase_id, mp.package_name, mp.description, ump.meals_remaining, ump.purchase_date " +
